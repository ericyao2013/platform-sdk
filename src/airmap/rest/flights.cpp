...
airmap::rest::Flights::Flights(Client::Version version, const std::shared_ptr<net::http::Requester>& requester)
...
void airmap::rest::Flights::search(const Search::Parameters& parameters, const Search::Callback& cb) {
  ...
  requester_->get(version_to_path(version_, "/flight/%s"), std::move(query), std::move(headers),
...
void airmap::rest::Flights::for_id(const ForId::Parameters& parameters, const ForId::Callback& cb) {
  ...
  requester_->get(version_to_path(version_, "/flight/%s/%s", parameters.id), std::move(query), std::move(headers),
                  [cb](const net::http::Requester::Result& result) {
                    if (result) {
                      cb(jsend::to_outcome<Flight>(json::parse(result.value().body)));
                    } else {
...
void airmap::rest::Flights::create_flight_by_point(const CreateFlight::Parameters& parameters,
  ...
  requester_->post(version_to_path(version_, "/flight/%s/point"), std::move(headers), j.dump(),
                   [cb](const net::http::Requester::Result& result) {
                     if (result) {
                       cb(jsend::to_outcome<Flight>(json::parse(result.value().body)));
                     } else {
...
void airmap::rest::Flights::create_flight_by_path(const CreateFlight::Parameters& parameters,
  ...
  requester_->post(version_to_path(version_, "/flight/%s/path"), std::move(headers), j.dump(),
                   [cb](const net::http::Requester::Result& result) {
                     if (result) {
                       cb(jsend::to_outcome<Flight>(json::parse(result.value().body)));
                     } else {
...
void airmap::rest::Flights::create_flight_by_polygon(const CreateFlight::Parameters& parameters,
  ...
  requester_->post(version_to_path(version_, "/flight/%s/polygon"), std::move(headers), j.dump(),
                   [cb](const net::http::Requester::Result& result) {
                     if (result) {
                       cb(jsend::to_outcome<Flight>(json::parse(result.value().body)));
                     } else {
...
void airmap::rest::Flights::end_flight(const EndFlight::Parameters& parameters, const EndFlight::Callback& cb) {
  ...
  requester_->post(version_to_path(version_, "/flight/%s/%s/end", parameters.id), std::move(headers), std::string{},
                   [cb](const net::http::Requester::Result& result) {
                     if (result) {
                       cb(jsend::to_outcome<EndFlight::Response>(json::parse(result.value().body)));
                     } else {
...
void airmap::rest::Flights::delete_flight(const DeleteFlight::Parameters& parameters,
  ...
  requester_->post(version_to_path(version_, "/flight/%s/%s/delete", parameters.id), std::move(headers), std::string{},
                   [cb](const net::http::Requester::Result& result) {
                     if (result) {
                       cb(jsend::to_outcome<DeleteFlight::Response>(json::parse(result.value().body)));
                     } else {
...
void airmap::rest::Flights::start_flight_communications(const StartFlightCommunications::Parameters& parameters,
  ...
  requester_->post(version_to_path(version_, "/flight/%s/%s/start-comm", parameters.id), std::move(headers),
                   std::string{}, [cb](const net::http::Requester::Result& result) {
                     if (result) {
                       cb(jsend::to_outcome<StartFlightCommunications::Response>(json::parse(result.value().body)));
                     } else {
...
void airmap::rest::Flights::end_flight_communications(const EndFlightCommunications::Parameters& parameters,
  ...
  requester_->post(version_to_path(version_, "/flight/%s/%s/end-comm", parameters.id), std::move(headers),
                   std::string{}, [cb](const net::http::Requester::Result& result) {
                     if (result) {
                       cb(jsend::to_outcome<EndFlightCommunications::Response>(json::parse(result.value().body)));
                     } else {
