...
double airmap::util::CheapRuler::bearing(const airmap::Geometry::Coordinate& p1, const airmap::Geometry::Coordinate& p2) const {
...
double airmap::util::CheapRuler::distance(const airmap::Geometry::Coordinate& p1, const airmap::Geometry::Coordinate& p2) const {
    auto dx = (p2.longitude - p1.longitude) * kx_;
    auto dy = (p2.latitude - p1.latitude) * ky_;
    return std::sqrt(dx * dx + dy * dy);
}

airmap::Geometry::Coordinate airmap::util::CheapRuler::destination(const airmap::Geometry::Coordinate& c, double distance, double bearing) const {
